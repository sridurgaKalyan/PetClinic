Feature: NavigatetoFindOwners

Scenario: Check the navigation to Find Owners Screen from Home Screen
...
Scenario: Find owner with last name
...
Scenario: Find all owners without entering last name
